...
1. Configure the Mixed Toolkit by selecting from the menu bar Mixed Reality Toolkit > Configure. If you don't see this menu item after importing the mixed reality toolkit, please restart Unity.
  ...
  >NOTE: Click "OK" on the pop up window and select the "DefaultMixedRealityToolkitConfigurationProfile".

  ![Lesson1 Chapter3 Step1](images/Lesson1Chapter3Step1b.PNG)

  ![Lesson1 Chapter3 Step1](images/Lesson1Chapter3Step1C.PNG)
